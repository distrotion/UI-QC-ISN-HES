...
abstract class TPGMCSCPR_Event {}

class TPGMCSCPR_READ extends TPGMCSCPR_Event {}

class TPGMCSCPR_Bloc extends Bloc<TPGMCSCPR_Event, TPGMCSCPRSCHEMA> {
  TPGMCSCPR_Bloc()
      : super(TPGMCSCPRSCHEMA(
          ItemPick: [''],
    ...
    on<TPGMCSCPR_READ>((event, emit) {
      return _TPGMCSCPR_READ(
          TPGMCSCPRSCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _TPGMCSCPR_READ(
      TPGMCSCPRSCHEMA toAdd, Emitter<TPGMCSCPRSCHEMA> emit) async {
    //--------------- READ
    ...
    TPGMCSCPRSCHEMA output = TPGMCSCPRSCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
