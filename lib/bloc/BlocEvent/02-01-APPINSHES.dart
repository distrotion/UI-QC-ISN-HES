...
abstract class APPINSHES_Event {}

class APPINSHES_READ extends APPINSHES_Event {}

class APPINSHES_Bloc extends Bloc<APPINSHES_Event, APPINSHESSCHEMA> {
  APPINSHES_Bloc()
      : super(APPINSHESSCHEMA(
          ItemPick: [''],
    ...
    on<APPINSHES_READ>((event, emit) {
      return _APPINSHES_READ(
          APPINSHESSCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _APPINSHES_READ(
      APPINSHESSCHEMA toAdd, Emitter<APPINSHESSCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "APPINSHESdb",
      data: {},
    );
    APPINSHESSCHEMA output = APPINSHESSCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
