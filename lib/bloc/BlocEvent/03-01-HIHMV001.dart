...
abstract class HIHMV001_Event {}

class HIHMV001_READ extends HIHMV001_Event {}

class HIHMV001_Bloc extends Bloc<HIHMV001_Event, HIHMV001SCHEMA> {
  HIHMV001_Bloc()
      : super(HIHMV001SCHEMA(
          ItemPick: [''],
    ...
    on<HIHMV001_READ>((event, emit) {
      return _HIHMV001_READ(
          HIHMV001SCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _HIHMV001_READ(
      HIHMV001SCHEMA toAdd, Emitter<HIHMV001SCHEMA> emit) async {
    //--------------- READ
