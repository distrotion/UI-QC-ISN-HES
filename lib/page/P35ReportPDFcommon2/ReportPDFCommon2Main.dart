...
//remark
    ...
    print("length-------");
    print(ReportPDFCommon2var.CUSLOT.length);
    double sizep = 16;
    if (ReportPDFCommon2var.CUSLOT.length > 100) {
      sizep = 12;
    }
                              ...
                              child: Column(
                                children: [
                                  ...
                                  HEAD16SLOT(
                                    ...
                                    widget02: Center(
                                      child: Text(
                                        ReportPDFCommon2var.rawlistDia.length >=
                                                1
                                            ? ReportPDFCommon2var
                                                .rawlistDia[0].DATANO
                                            : '',
