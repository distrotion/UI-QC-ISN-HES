...
class _ReportPDFACTState extends State<ReportPDFACT> {
  ...
  void initState() {
    ...
    if (d == '2') {
      setState(() {
        ReportPDFACTvar.SCMASKTYPE = SCMASK02;
      });
    } else if (d == '3') {
      setState(() {
        ReportPDFACTvar.SCMASKTYPE = SCMASK04;
      });
    } else if (d == '4') {
      setState(() {
        ReportPDFACTvar.SCMASKTYPE = new19062401;
      });
    } else if (d == '5') {
      setState(() {
        ReportPDFACTvar.SCMASKTYPE = new19062402;
      });
    } else {
      setState(() {
        ReportPDFACTvar.SCMASKTYPE = SCMASK03;
      });
    }
  ...
  Widget build(BuildContext context) {
    ...
    double sizep = 16;
    if (ReportPDFACTvar.CUSLOT.length > 100) {
      sizep = 12;
    }
